...
for i in range(3):
  for j in range(3):
   b[i][j]=Button(font=("tims",56),width=1,height=1,bg="yellow",command=lambda r=i,c=j:callback(r,c))
   b[i][j].grid(row=i,column=j)
player='X'
stop_game=True
mainloop()
const listItemArray=$('.list-group-item');
