...
@d3vil_cmd(pattern="monster$")
async def _(monster):
    await eor(monster, G)


@d3vil_cmd(pattern="pig$")
async def _(pig):
    await eor(pig, H)


@d3vil_cmd(pattern="gun$")
async def _(gun):
    await eor(gun, I)


@d3vil_cmd(pattern="dog$")
async def _(dog):
    await eor(dog, J)


@d3vil_cmd(pattern="hello$")
async def _(hello):
    await eor(hello, K)


@d3vil_cmd(pattern="hmf$")
async def _(hmf):
    await eor(hmf, L)


@d3vil_cmd(pattern="couple$")
async def _(couple):
    await eor(couple, M)


@d3vil_cmd(pattern="sup$")
async def _(supreme):
    await eor(supreme, N)


@d3vil_cmd(pattern="india$")
async def _(event):
    await eor(event, O)


@d3vil_cmd(pattern="wc$")
async def _(welcome):
    await eor(welcome, P)


@d3vil_cmd(pattern="snk$")
async def _(snake):
    await eor(snake, Q)


@d3vil_cmd(pattern="bye$")
async def _(bye):
    await eor(bye, R)


@d3vil_cmd(pattern="shitos$")
async def _(shitos):
    await eor(shitos, S)


@d3vil_cmd(pattern="dislike$")
async def _(dislike):
    await eor(dislike, T)
