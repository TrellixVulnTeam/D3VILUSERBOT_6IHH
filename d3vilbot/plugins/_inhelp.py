...
D3VIL_FIRST = (
    "**Hello, 𝖳𝗁𝗂𝗌 𝗂𝗌 𝔇3𝔳𝔦𝔩𝔅𝔬𝔱 𝖴𝗅𝗍𝗋𝖺 𝖯𝗋𝗂𝗏𝖺𝗍𝖾 𝖲𝖾𝖼𝗎𝗋𝗂𝗍𝗒 𝖯𝗋𝗈𝗍𝗈𝖼𝗈𝗅⚠️ **\n 𝖳𝗁𝗂𝗌 𝗂𝗌 𝗍𝗈 𝗂𝗇𝖿𝗈𝗋𝗆 𝗒𝗈𝗎 𝗍𝗁𝖺𝗍 "
    "{} 𝗂𝗌 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 𝗎𝗇𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾. 𝖳𝗁𝗂𝗌 𝗂𝗌 𝖺𝗇 𝖺𝗎𝗍𝗈𝗆𝖺𝗍𝖾𝖽 𝗆𝖾𝗌𝗌𝖺𝗀𝖾.\n\n"
    "{}\n\n**𝖯𝗅𝖾𝖺𝗌𝖾 𝖢𝗁𝗈𝗈𝗌𝖾 𝖶𝗁𝗒 𝖸𝗈𝗎 𝖠𝗋𝖾 Inbox my Master {d3vil_mention}!!**".format(d3vil_mention, mssge))
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
            ...
            reply_pop_up_alert = "𝖧𝖾𝗅𝗅𝗈 𝗍𝗁𝖾𝗋𝖾 𝖣𝖾𝗉𝗅𝗈𝗒 𝗒𝗈𝗎𝗋 𝗈𝗐𝗇 𝖣3𝖵𝖨𝖫𝖡𝖮𝖳 𝖺𝗇𝖽 𝗎𝗌𝖾. © 𝔇3𝔳𝔦𝔩𝔅𝔬𝔱 ™"
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
    ...
    async def page(event):
        ...
        if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
            ...
            return await event.answer(
                "𝖧𝖾𝗅𝗅𝗈 𝗍𝗁𝖾𝗋𝖾 𝖣𝖾𝗉𝗅𝗈𝗒 𝗒𝗈𝗎𝗋 𝗈𝗐𝗇 𝖣3𝖵𝖨𝖫𝖡𝖮𝖳 𝖺𝗇𝖽 𝗎𝗌𝖾. © 𝔇3𝔳𝔦𝔩𝔅𝔬𝔱 ™",
                cache_time=0,
                alert=True,
            )
