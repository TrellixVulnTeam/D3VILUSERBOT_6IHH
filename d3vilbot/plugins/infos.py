...
@d3vil_cmd(pattern="recognize(?:\s|$)([\s\S]*)")
async def _(event):
...
<b>⚡ <a href='https://t.me/D3VIL_BOT_OFFICIAL'>From DataBase of d3vilBot</a> ⚡ </b>
""".format(
        user_id,
        user_id,
        first_name,
...
@d3vil_cmd(pattern="chatinfo(?:\s|$)([\s\S]*)")
...
@d3vil_cmd(pattern="admins(?:\s|$)([\s\S]*)")
async def _(event):
