...
@d3vil _cmd(pattern="ytube(?:\s|$)([\s\S]*)")
async def _(event):
...
@d3vil _cmd(pattern="lmlog(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@d3vil _cmd(pattern="rchiv(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
